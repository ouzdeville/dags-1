...
//Allocates space for a polynomial
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//              La fonction poly_alloc permet de faire les allocations de memoire
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//               La fonction Poly_copy permet de dfaire une copie du polynome p
//                                 dans un autre polynome q
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//              La fonction poly_set_to_zero  permet de mettre les coefficients � zero
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//                          La fonction poly_calcule_deg permet de calculer
//                                 et de redefinir le degre du polyn�me
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
// La fonction poly_eval_aux evalue un polynome represente par ses coefficients coeff, de degre d en un
//      gf a
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void poly_add_free(poly_t r, poly_t a, poly_t b)
{
	...
	{
		r->deg=b->deg;
		for (i=0;i<r->deg+1;i++) r->coeff[i]=b->coeff[i];
	}
	else if (b->deg==-1)
	{

		r->deg=a->deg;
		for (i=0;i<r->deg+1;i++) r->coeff[i]=a->coeff[i];
	}
	else
	{
		if (a->deg==b->deg)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//   La fonction poly_eval utilise la fonction poly_eval_aux pour evaluer un polynome en un point a
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//   La fonction poly_rem cacule le reste de p modulo g et le resultat est stocke dans p
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//              The fonction poly_poly_quo Returns the quotient of p an q
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    for(i=t-2;i>=0;i--)
		{
	     ...
	     gf_Mult(support[j],poly_coeff(F[j],i+1))));
		}
    a = gf_add(poly_coeff(generator,0),gf_Mult(support[j],poly_coeff(F[j],0)));
    for(i=0;i<t;i++)
		{
